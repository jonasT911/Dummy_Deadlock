 ...
 */
JNIEXPORT jobjectArray JNICALL Java_java_lang_reflect_Field_getAnnotations
  (JNIEnv *, jobject);
 ...
 */
JNIEXPORT jobject JNICALL Java_java_lang_reflect_Field_getAnnotation
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_java_lang_reflect_Field_isSynthetic
  (JNIEnv *, jobject);
 ...
 * Signature: ()[Ljava/lang/annotation/Annotation;
 */
JNIEXPORT jobjectArray JNICALL Java_java_lang_reflect_Field_getDeclaredAnnotations
  (JNIEnv *, jobject);
